...
// 占位文字的frameY
static const void *zw_placeHolderFrameYKey = &zw_placeHolderFrameYKey;
...
/*
//设置Y值
-(void)setPlaceHolderLBY:(CGFloat)placeHolderLBY{
    
    objc_setAssociatedObject(self, &zw_placeHolderFrameYKey, placeHolderLBY, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
       [self updatePlaceHolder];
    
    CGRect tempFrame = self.zw_placeHolderLabel.frame;
    
    tempFrame.origin.y = placeHolderLBY;

    self.zw_placeHolderLabel.frame = tempFrame;
