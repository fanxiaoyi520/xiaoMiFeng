...
+ (UIImage *)jm_imageWithRoundedCornersAndSize:(CGSize)sizeToFit CornerRadius:(CGFloat)radius borderColor:(UIColor *)borderColor borderWidth:(CGFloat)borderWidth withBgColor:(UIColor *)bgColor
{
    return [UIImage jm_imageWithRoundedCornersAndSize:sizeToFit CornerRadius:radius borderColor:borderColor borderWidth:borderWidth backgroundColor:bgColor backgroundImage:nil withContentMode:UIViewContentModeScaleToFill];
}
...
+ (UIImage *)jm_imageWithColor:(UIColor*)color andRect:(CGRect)rect
{
