...
//    self.view.backgroundColor = UIColorFromRGBA(0xFAFAFA, 0.5f);
    self.view.backgroundColor = UIColorFromRGBA(0x000000, 0.7f);
...
//    view.tintColor = [UIColor colorWithRGBString:@"#F0F0F0"];
    view.tintColor = UIColorFromRGB(0xF0F0F0);
}
...
//        layer.strokeColor = [UIColor colorWithRGBString:cellSeparatorLineColor].CGColor;
        layer.strokeColor = UIColorFromRGB(0xECECEC).CGColor;
...
//            lineLayer.backgroundColor = [UIColor colorWithRGBString:cellSeparatorLineColor].CGColor;
            lineLayer.backgroundColor = UIColorFromRGB(0xECECEC).CGColor;
