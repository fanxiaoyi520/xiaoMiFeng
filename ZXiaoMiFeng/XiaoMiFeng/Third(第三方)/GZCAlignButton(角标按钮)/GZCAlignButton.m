...
//            badgeY = CGRectGetMinY(_titleLabel.frame) < CGRectGetMinY(_imageView.frame) ? CGRectGetMinY(_titleLabel.frame) : CGRectGetMinY(_imageView.frame);
            ...
            badgeX = CGRectGetMinX(_imageView.frame) + CGRectGetWidth(_imageView.frame) - 8;
            badgeY = CGRectGetMinY(_titleLabel.frame) < CGRectGetMinY(_imageView.frame) ? CGRectGetMinY(_titleLabel.frame) : CGRectGetMinY(_imageView.frame);
            break;
        }
...
//            _badgeLabel.text  = @"";
            ...
            //计算角标的宽度
            float minwidth = [NSString SG_widthWithString:_badge font:_badgeLabel.font] + 5;
            
            minwidth > minheight ? minwidth:(minwidth = minheight);
            
            _badgeLabel.frame = CGRectMake(0, 0, minwidth, minheight);
  
            _badgeLabel.layer.cornerRadius = _badgeRadius;
            
//            [_badgeLabel cornerWithRadius:_badgeRadius];
