...
//标识支付方式类型，比如：ALIPAYHK(香港钱包支付)
@property (nonatomic, copy) NSString *secondary_merchant_id;
@property (nonatomic, copy) NSString *secondary_merchant_industry;
@property (nonatomic, copy) NSString *secondary_merchant_name;
